...
import { DIAGRAM_ALIGN_ACTION_LAYOUT, DIAGRAM_CLIPBOARD_ACTION_LAYOUT, DIAGRAM_FILE_ACTION_LAYOUT, DIAGRAM_GROUP_ACTION_LAYOUT, DIAGRAM_HISTORY_ACTION_LAYOUT, DIAGRAM_TEXT_ALIGN_ACTION_LAYOUT, DIAGRAM_VIEW_ACTION_LAYOUT, DIAGRAM_ZOOM_ACTION_LAYOUT, DIAGRAM_ZORDER_ACTION_LAYOUT } from '../diagram.action.layouts';
