 ...
 * It extends the Bpmn_EventAdapter to leverage basic circle rendering capabilities while adding specific logic for handling BPMN start events and hit testing.
 * Registers with the NodeRegistry under the name 'bpmn_start_event'.
 */
export class BpmnStartEventAdapter extends AbstractBpmnEventAdapter {

    public static TYPE = 'bpmn_start_event';
