 ...
 * It extends the RectangleAdapter to leverage basic rectangle rendering capabilities while adding specific logic for handling horizontal pool shapes and hit testing.
 * Registers with the NodeRegistry under the name 'horizontal_pool'.
 */
export class HorizontalPoolAdapter extends RectangleAdapter {
